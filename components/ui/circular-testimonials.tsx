...
export const CircularTestimonials = ({
  ...
  const colorArrowBg = colors.arrowBackground ?? "#2a2618";
  const colorArrowFg = colors.arrowForeground ?? "#f0ede8";
  const colorArrowHoverBg = colors.arrowHoverBackground ?? "#F5A020";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: "1rem", paddingTop: "2.5rem" }}>
            ...
            >
              <FaArrowLeft size={16} color={hoverPrev ? "#161616" : colorArrowFg} />
            </button>
            <button
              onClick={handleNext}
            ...
            >
              <FaArrowRight size={16} color={hoverNext ? "#161616" : colorArrowFg} />
            </button>
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  style={{
                    ...
                    height: 6,
                    borderRadius: 999,
                    backgroundColor: i === activeIndex ? "#F5A020" : "rgba(255,255,255,0.2)",
